...
// Require login to access sale properties
requireLogin();
...
<div class="inside-banner">
  <div class="container">
    <h2 class="text-center">Properties for Sale</h2>
    <p class="text-center text-light">Find your dream property to own</p>
  </div>
</div>
...
<div class="sortby clearfix mb-4">
  <div class="row">
    <div class="col-md-6">
      <div class="result"><i class="fas fa-list"></i> Showing: Properties for Sale</div>
    </div>
  </div>
</div>
